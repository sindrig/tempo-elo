...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(to='fifa_elo.Player', related_name='aurochs'),
        ),
        migrations.AddField(
            model_name='match',
            name='team_1_player_2',
            field=models.ForeignKey(to='fifa_elo.Player', related_name='beasts'),
        ),
        migrations.AddField(
            model_name='match',
            name='team_2_player_1',
            field=models.ForeignKey(to='fifa_elo.Player', related_name='goers'),
        ),
        migrations.AddField(
            model_name='match',
            name='team_2_player_2',
            field=models.ForeignKey(to='fifa_elo.Player', related_name='fangs'),
        ),
    ]
